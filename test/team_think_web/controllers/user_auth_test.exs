defmodule TeamThinkWeb.UserAuthTest do
  use TeamThinkWeb.ConnCase, async: true

  alias TeamThink.Accounts
  alias TeamThinkWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TeamThinkWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TeamThinkWeb.Endpoint.subscribe(live_socket_id)
